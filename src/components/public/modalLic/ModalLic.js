...
const ModalLic = ({showModal, hideModalFunction, data, req}) => {
    return(
        <Modal 
            open={showModal} 
          ...
          <div className="row justify-content-around my-2">
            ...
            <Plain title='Quinto Semestre' plain={data.plan.quinto}/>
            <Plain title='Sexto Semestre' plain={data.plan.sexto}/>
            <Plain title='Séptimo Semestre' plain={data.plan.septimo}/>
            <Plain title='Octavo Semestre' plain={data.plan.octavo}/>
          </div>
...
ModalLic.defaultProps = {
    data: {
        ...
        plan: {
            ...
            quinto:[{p:'materia'},{p:'materia'}],
            sexto:[{p:'materia'},{p:'materia'}],
            septimo:[{p:'materia'},{p:'materia'}],
            octavo:[{p:'materia'},{p:'materia'}]
        }
    },
    req:[{p:'requisitos'}]
}

export default ModalLic;